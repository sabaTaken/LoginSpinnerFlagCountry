...
public class CountryCodeSpinner extends AppCompatSpinner {
    ...
    public static final String COUNTRY_NAME = "نام کشور";
    ...
    /**
     * برگرداندن لیست کلی مدل
     *
     * @return
     */
    public  ArrayList<CountryModel> getArray(){
        return arrayList;
    }
     ...
     * @return
     */
    public ArrayList<String> getArrayName(ArrayList<CountryModel> arrayList){

        ArrayList<String> arrayListString = new ArrayList<>();
        arrayListString.clear();

        for (CountryModel countryModel:arrayList){
            arrayListString.add(countryModel.countryName);
        }
     ...
     * @return
     */
    public ArrayList<String> getArrayPhoneCode(ArrayList<CountryModel> arrayList){

        ArrayList<String> arrayListString = new ArrayList<>();
        arrayListString.clear();

        for (CountryModel countryModel:arrayList){
            arrayListString.add(countryModel.getCountryCode());
        }
    ...
    private void fillCountryList() {
        ...
        arrayList.clear();
        arrayList.add(new CountryModel("", COUNTRY_NAME, CODE, ""));
    ...
    class CountryModel {
        ...
        private String iso, countryCode, countryName, countryFlag;

        public CountryModel(String iso, String countryName, String countryCode, String countryFlag) {
            this.iso = iso;
    ...
    public static class CountryCodeAdapter extends ArrayAdapter<CountryModel> {
        ...
        private View createItemView(int position, View convertView, ViewGroup parent) {
            ...
            if (resource == 0) {
                ...
                ccTextView.setBackgroundColor(Color.TRANSPARENT);
                ccTextView.setTextColor(Color.BLACK);
                ccTextView.setPadding(10, 5, 10, 5);
                ccTextView.setTextSize(15);
                String str = model.getCountryFlag() + "  " + model.getCountryName() + "  (" + model.getCountryCode() + ")";
                String str2 = model.getCountryFlag() + "  " + model.getCountryName() ;
                ccTextView.setText(model.getCountryName().equals(COUNTRY_NAME) ? str2 : str);
                rootLayout.addView(ccTextView);
                view = rootLayout;
            } else {
                view = inflater.inflate(resource, parent, false);
                AppCompatTextView tvCountry = (AppCompatTextView) view.findViewById(R.id.tvCountry);
                tvCountry.setText(model.getCountryFlag() + "  " + model.getCountryName() + "  (" + model.getCountryCode() + ")");
            }
